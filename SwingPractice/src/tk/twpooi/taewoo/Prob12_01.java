...
public class Prob12_01 {
	...
	public static void main(String[] args) {
		...
		f.setTitle("Prob12_01");
		f.setSize(800, 800);
		
		Prob12_01Panel panel = new Prob12_01Panel();
		f.add(panel);
...
class Prob12_01Panel extends JPanel implements MouseListener, MouseMotionListener {
	
	Prob12_01Panel p = this;
	
	ArrayList<MyCircle12_01> list;
	int count = 0;
	...
	class MyCircle12_01 implements Runnable{
		...
		MyCircle12_01(double x, double y, int r, Color color){
	...
	private void addCircle(int x, int y, int r, Color co){
		...
		list.add(new MyCircle12_01(x, y, r, co));
